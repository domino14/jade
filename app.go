...
func (a *App) NewGame(lexicon, boardLayoutName, letterDistributionName string,
	challengeRuleName string, player1, player2 string) ([]byte, error) {
	...
	// wails autogenerated code does not play nicely with protobuf, specifically
	// byte arrays (they get serialized and then deserialized as b64 strings)
	// so let's just return the protobuf serialization of it and deserialize it
	// on the front end.
	if err != nil {
		return nil, err
	}
	return proto.Marshal(gdoc)
}
